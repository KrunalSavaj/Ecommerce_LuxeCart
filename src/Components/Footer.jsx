  ...
  return (
    <div className="f">
      <div className="flex flex-col sm:grid grid-cols-[3fr_1fr_1fr] gap-14 my-10 mt-40 text-sm ">
        <div className="">
          <img src={assets.logo} alt="" className="mb-5 w-48 " />
          <p className="w-full sm:w-2/3 text-gray-600">
            Shop with LuxeCart and experience the convenience of online shopping
            like never before.
          </p>
        </div>
        ...
        <div className="">
          ...
          <ul className="flex flex-col flex-1 text-gray-600">
            ...
            <li className="mb-2">developer.krunalsavaj@gmail.com </li>
          </ul>
        </div>
      </div>
      <div>
        ...
        <p className="py-5 text-sm text-center">
          Copyright 2025@LuxeCart- All Rights Reserved
        </p>
      </div>
    </div>
  );
